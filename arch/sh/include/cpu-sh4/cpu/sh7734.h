...
enum {
	SHDMA_SLAVE_INVALID,
	/* channel 00-10 */
	SHDMA_SLAVE_SCIF0_TX,	SHDMA_SLAVE_SCIF0_RX,
	SHDMA_SLAVE_SCIF1_TX,	SHDMA_SLAVE_SCIF1_RX,
	...
	SHDMA_SLAVE_SCIF5_TX,	SHDMA_SLAVE_SCIF5_RX,
	SHDMA_SLAVE_HSPI_TX,	SHDMA_SLAVE_HSPI_RX,
	SHDMA_SLAVE_FLCTL_TX,	SHDMA_SLAVE_FLCTL_RX,
	SHDMA_SLAVE_ADC_TX,	SHDMA_SLAVE_ADC_RX,
	SHDMA_SLAVE_MTU2_TX,	SHDMA_SLAVE_MTU2_RX,
	/* channel 11-18 */
	SHDMA_SLAVE_SSI0_TX,	SHDMA_SLAVE_SSI0_RX,
	SHDMA_SLAVE_SSI1_TX,	SHDMA_SLAVE_SSI1_RX,
	SHDMA_SLAVE_SSI2_TX,	SHDMA_SLAVE_SSI2_RX,
	SHDMA_SLAVE_SSI3_TX,	SHDMA_SLAVE_SSI3_RX,
	SHDMA_SLAVE_SRC0_TX,	SHDMA_SLAVE_SRC0_RX,
	SHDMA_SLAVE_SRC1_TX,	SHDMA_SLAVE_SRC1_RX,
	SHDMA_SLAVE_I2C0_TX,	SHDMA_SLAVE_I2C0_RX,
	SHDMA_SLAVE_I2C1_TX,	SHDMA_SLAVE_I2C1_RX,
	SHDMA_SLAVE_MIMLB_TX,	SHDMA_SLAVE_MIMLB_RX,
	/* channel 19-20 */
	SHDMA_SLAVE_USBF0_TX,	SHDMA_SLAVE_USBF0_RX,
	SHDMA_SLAVE_USBF1_TX,	SHDMA_SLAVE_USBF1_RX,
	/* channel 21-22 */
	SHDMA_SLAVE_HSCIF_TX,	SHDMA_SLAVE_HSCIF_RX,
	/* channel 23-25 */
	SHDMA_SLAVE_SDHI0_TX,	SHDMA_SLAVE_SDHI0_RX,
	SHDMA_SLAVE_SDHI1_TX,	SHDMA_SLAVE_SDHI1_RX,
	SHDMA_SLAVE_SDHI2_TX,	SHDMA_SLAVE_SDHI2_RX,
	/* channel 27-28 */
	SHDMA_SLAVE_MMC_TX,	SHDMA_SLAVE_MMC_RX,
	SHDMA_SLAVE_RSPI_TX,	SHDMA_SLAVE_RSPI_RX,
	SHDMA_SLAVE_QSPI_TX,	SHDMA_SLAVE_QSPI_RX,
};
